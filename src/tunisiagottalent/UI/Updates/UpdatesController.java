...
*/
        ...
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/tunisiagottalent/UI/Updates/UpdatesList.fxml"));
        ContentPane.getChildren().setAll(pane);
        }
        
    }
 @FXML
    void UpdatesList(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/tunisiagottalent/UI/Updates/UpdatesList.fxml"));
        ContentPane.getChildren().setAll(pane);
    }
    @FXML
