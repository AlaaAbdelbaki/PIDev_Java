...
public class ShopController implements Initializable {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        editbutton.setOnAction(event ->{
                            ...
                            try {
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Shop/EditProduct.fxml"));
    ...
    public void afficheraddproduct(){
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/UI/Shop/AddProduct.fxml"));
    ...
    public void gotoorderlist() throws IOException{
            AnchorPane pane=FXMLLoader.load(getClass().getResource("/UI/Shop/Order.fxml"));
            rootPane.getChildren().setAll(pane);
    }
    
    public void gotohomeshop() throws IOException{
            AnchorPane pane=FXMLLoader.load(getClass().getResource("/UI/Shop/ShopView.fxml"));
            rootPane.getChildren().setAll(pane);
    }
